...
import { IResourceComponentActionBulkOptionsAction, IResourceComponentActionRowRecord, IResourceComponentFormFieldRecord } from './actions.js';
...
export interface ISchemaObjectExtensionFieldRest {
  ...
  'dtoActions'?: IResourceComponentActionBulkOptionsAction[];
  //
  'fieldSource'?: string;
  'visible'?: boolean;
  'order'?: number;
