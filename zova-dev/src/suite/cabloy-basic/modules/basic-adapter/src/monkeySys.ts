...
import type { IResourceProviders } from 'zova-module-a-openapi';
...
export class MonkeySys extends BeanSimple implements IMonkeySysInitialize {
  async sysInitialize() {
    // config custom
    const configCustom: IResourceProviders = {
      behaviors: {
    ...
    scopeRestConfig.resourceProviders = deepExtend({}, scopeRestConfig.resourceProviders, configCustom);
  }
}
